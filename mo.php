...
<div class="d2"><img src="<?php echo $img ?>" width="300px" height="200px" style=" border-radius:30px;">
</div>
<p style="color:red;position:absolute;right:200px;">Auction Starts in</p>
<div id="clockdiv" style="position:absolute;right:40px;">
