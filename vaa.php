...
function gAdd(){
            var address= document.form1.address.value;
                ...
                if(document.form1.address.value.search(fnam)==-1)
                 {
                      alert("Enter correct  Name");
                      document.form1.address.focus();
				...
				if(document.form1.dob.value=="")
   {
	...
	if((document.form1.gr[0].checked==false)&&(document.form1.gr[1].checked==false))
	{
	   ...
	   return false;
		...
		var address= document.form1.address.value;
                if((address===null)||(address.length<5)){
                    document.form1.address.style.border = "1px solid red";
                    alert("Enter Full Name");
                    document.form1.address.focus();
                    return false;
                }
...
var city = form1.city.value;
 ...
 <form name="form1" action="login.php" method="POST" id="form" enctype="multipart/form-data" onsubmit="return addUser()">
...
<div class="form-group">
	...
	<textarea name="address" id="address" rows="3" cols="5" placeholder="Enter your address..." class="contact-subject form-control" required onChange="return gAdd()" ></textarea>
    </div>
	<div class="form-group">
 </div>
...
<?php
   ...
   <input type="file" name="photo" id="photo" required></div>
    							
	                      <div> <center> <a href="login.php"><button type="submit" name="submit" value="submit" class="btn">Register</button></a></center>
