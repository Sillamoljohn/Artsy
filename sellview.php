...
<div class="col-sm-10 col-sm-offset-1 page-title wow fadeIn">
		...
		<body>
		 <p>&nbsp;</p>
		 <table width="726" id="customers" border="1" align="center">
<tr>
                        <th width="55" scope="row"><div align="center">S/no</div></th>
                        <th width="137"><div align="center"><strong>Art Name</strong></div></th >
                        <th width="144"><div align="center"><strong>Artist Name</strong></div></th >
    <th width="174"> <div align="center"><strong>Collector Name</strong></div></th >
 ...
 $totalprice=0;
 $i=1;
 $result9 ="SELECT * FROM mycart where status1=1";
...
$result11 ="SELECT * FROM aregistration where areg='$areg'";
...
?>
                      ...
                      <tr>
                        ...
                        <td><div align="center"><?php echo $fname." ".$lname;?></div></td>
