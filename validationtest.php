...
<div class="form-group">		  
	...
	<textarea name="address" id="address" rows="3" cols="5" placeholder="Enter your address..." class="contact-subject form-control" required onChange="return Addr()" ></textarea>
    </div>
	<div class="form-group">
	<label for="contact-subject">Education</label>
	<textarea name="edu" id="edu" rows="3" cols="5" placeholder="Enter your address..." class="contact-subject form-control "required onChange="return Edu()" ></textarea>
    </div>
	<div class="form-group">
...
<div class="form-group">
   ...
   <input type="file" name="photo1" id="photo1" required></div>
